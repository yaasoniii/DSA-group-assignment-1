...
Two independent parts, each in its own top-level folder — Question 1 is a REST API,
Question 2 is gRPC.
...
│
── Question 2 (Rental system)/        # Question 2 — gRPC 
    ── proto/
...
Things worth noting for Question 1
